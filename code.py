...
df1=pd.read_csv('https://github.com/SaicharanRitwik39/HostMillProject/blob/main/Jan14.csv', error_bad_lines = False)
df2=pd.read_csv('https://github.com/SaicharanRitwik39/HostMillProject/blob/main/Feb14.csv', error_bad_lines = False)
df3=pd.read_csv('https://github.com/SaicharanRitwik39/HostMillProject/blob/main/Mar14.csv', error_bad_lines = False)
df4=pd.read_csv('https://github.com/SaicharanRitwik39/HostMillProject/blob/main/Apr14.csv', error_bad_lines = False)
